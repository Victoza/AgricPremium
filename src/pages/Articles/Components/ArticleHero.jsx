    ...
    <section className='py-12 flex items-center'>
      <div className='grid grid-cols-1 md:grid-cols-2 container mx-auto p-6 md:p-12 gap-6'>
        <div className='space-y-4 md:space-y-6'>
          <p>Knowledge Hub</p>
          <h2 className='text-2xl md:text-4xl lg:text-5xl font-semibold'>Cultivating Nigerian Agricultural Experience</h2>
          ...
          <div className='flex flex-col md:flex-row gap-4'>
            ...
            <button className='bg-white rounded-full text-green-700 border px-6 py-2 cursor-pointer'>Explore Topics</button>
          </div>
        </div>
