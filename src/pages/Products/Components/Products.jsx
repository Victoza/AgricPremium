...
const Products = () => {
  ...
  return (
    <section className='py-12'>
        ...
        <div className=''>
            ...
            <div className='flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6'>
                ...
                <div className='flex justify-end gap-2'>
                    <button className='flex items-center border rounded-xl px-2'><IoFilter /> Filter</button>
                    <button className='p-2 border rounded-xl px-2'>Sort by Featured</button>
                </div>
            </div>  
        </div>
        ...
        <div className=' grid justify-center grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4'>
            {prods.map((prod) =>(
                <Card/>
            ))}
        </div>
