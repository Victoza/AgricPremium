        ...
        <div className='flex items-center'>
            <div className='w-full flex flex-col justify-center gap-12'>
                ...
                <div className='flex flex-col md:flex-row space-x-8 gap-4'>
                    <button className='bg-green-800 flex justify-center items-center gap-2 rounded-3xl text-white font-semibold px-4 py-4'><span></span>Book Appointment<BiCalendar/></button>
